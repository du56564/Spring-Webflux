package com.bofa.microservices;
...
import com.bofa.microservices.handler.ProductHandler;
import com.bofa.microservices.model.Product;
import com.bofa.microservices.repository.ProductRepository;
	...
	CommandLineRunner init(ReactiveMongoOperations operations, ProductRepository repository) {
		return args -> {
			Flux<Product> productFlux = Flux.just(
					new Product(null, "Choclate", 2.99),
					new Product(null, "Latte Cofee", 2.49),
